...
with conn:
    cur = conn.cursor()
    cur.execute("SELECT information.docx, Hello.txt, myImage.png, myMovie.mpg, World.txt, data.pdf, myPhoto.jpg FROM tbl_extension WHERE TEXT = '.txt'") #Selecting data with the filename extension of .txt
